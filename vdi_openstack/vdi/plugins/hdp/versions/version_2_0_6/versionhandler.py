...
from vdi.plugins.hdp import configprovider as cfgprov
from vdi.plugins.hdp.versions import abstractversionhandler as avm
from vdi.plugins.hdp.versions.version_2_0_6 import services
