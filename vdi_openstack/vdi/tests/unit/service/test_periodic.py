...
import vdi.service.periodic as p
import vdi.tests.unit.base as base
from vdi.tests.unit.conductor.manager import test_clusters as tc
...
class TestPeriodicBack(base.SaharaWithDbTestCase):
    ...
    @mock.patch('vdi.service.edp.job_manager.get_job_status')
    ...
    @mock.patch('vdi.service.edp.job_manager.get_job_status')
    @mock.patch('vdi.service.api.terminate_cluster')
