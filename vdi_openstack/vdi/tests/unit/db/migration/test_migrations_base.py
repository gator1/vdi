...
import vdi.db.migration
from vdi.openstack.common.db.sqlalchemy import session
from vdi.openstack.common import lockutils
from vdi.openstack.common import log as logging
from vdi.openstack.common import processutils


LOG = logging.getLogger(__name__)
CONF = cfg.CONF

synchronized = lockutils.synchronized_with_prefix('vdi-')
...
class BaseMigrationTestCase(unittest2.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ALEMBIC_CONFIG = alembic_config.Config(
            os.path.join(os.path.dirname(vdi.db.migration.__file__),
                         'alembic.ini')
        )
