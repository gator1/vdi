...
from vdi.tests.integration.tests import cinder
from vdi.tests.integration.tests import cluster_configs
from vdi.tests.integration.tests import edp
from vdi.tests.integration.tests import map_reduce
from vdi.tests.integration.tests import scaling
from vdi.tests.integration.tests import swift
...
#----------------------------------EDP TESTING---------------------------------
        ...
        path = 'vdi/tests/integration/tests/resources/'
