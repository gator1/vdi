...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example::
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/vdi/sqlite.db",
        sqlite_db="/var/lib/vdi/sqlite.db")
...
from vdi.openstack.common.db import exception
    ...
    def _do_query(self, q):
        ...
        for filename, line, method, function in traceback.extract_stack():
            ...
            if filename.endswith('db/api.py'):
                continue
            # only trace inside vdi
            index = filename.rfind('vdi')
            if index == -1:
                continue
