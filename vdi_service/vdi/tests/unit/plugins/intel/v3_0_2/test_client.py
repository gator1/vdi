...
from vdi.plugins.intel import exceptions as iex
from vdi.plugins.intel.v3_0_2 import client as c
from vdi.tests.unit import base
from vdi.tests.unit.plugins.intel.v3_0_2 import response as r
...
class TestClient(base.SaharaTestCase):
    ...
    @mock.patch('vdi.context.sleep', lambda x: None)
    @mock.patch('requests.sessions.Session.post')
    @mock.patch('requests.sessions.Session.get')
