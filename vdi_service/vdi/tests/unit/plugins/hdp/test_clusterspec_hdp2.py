...
from vdi.plugins.hdp.versions.version_2_0_6 import services as s2
...
@mock.patch('vdi.plugins.hdp.versions.version_2_0_6.services.HdfsService.'
    ...
    def test_topology_configuration_no_hypervisor(self, patched):
        ...
        try:
            ...
            self.assertEqual(
                'true',
                cluster_config.configurations['core-site']
                ['fs.swift.service.vdi.location-aware'])
            self.assertEqual(
