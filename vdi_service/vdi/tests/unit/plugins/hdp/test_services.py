...
class ServicesTest(unittest2.TestCase):
    ...
    @mock.patch(
        'vdi.plugins.hdp.versions.version_1_3_2.services.HdfsService.'
    ...
    @mock.patch("vdi.utils.openstack.nova.get_instance_info",
                hdp_test_base.get_instance_info)
    @mock.patch(
        'vdi.plugins.hdp.versions.version_2_0_6.services.HdfsService.'
        '_get_swift_properties',
        return_value=[])
