...
from vdi.plugins.hdp import ambariplugin as ap
from vdi.plugins.hdp import clusterspec as cs
import vdi.tests.unit.plugins.hdp.hdp_test_base as base
from vdi import version


GET_REST_REQ = "vdi.plugins.hdp.versions.version_1_3_2.versionhandler." \
...
class AmbariPluginTest(unittest2.TestCase):
    ...
    @mock.patch("vdi.utils.openstack.nova.get_instance_info",
                base.get_instance_info)
    @mock.patch('vdi.plugins.hdp.versions.version_1_3_2.services.'
