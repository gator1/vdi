...
from vdi.conductor import objects as o
...
class TopologyTestCase(base.SaharaTestCase):
    ...
    @mock.patch('vdi.utils.openstack.nova.client')
    @mock.patch('vdi.topology.topology_helper._read_compute_topology')
    @mock.patch('vdi.topology.topology_helper._read_swift_topology')
