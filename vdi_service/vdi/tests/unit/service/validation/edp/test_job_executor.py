...
from vdi.service.validations.edp import job_executor as je
...
class TestJobExecValidation(u.ValidationTestCase):
    ...
    @mock.patch('vdi.service.validations.base.check_cluster_exists')
    @mock.patch('vdi.service.validations'
                '.edp.base.check_data_source_exists')
    @mock.patch('vdi.service.edp.api.get_job')
