...
from vdi.service import direct_engine as e
from vdi.tests.unit import base
import vdi.utils.crypto as c
...
class AbstractInstanceTest(base.SaharaWithDbTestCase):
    def setUp(self):
        ...
        self.is_passthrough_patcher = mock.patch(
            'vdi.conductor.resource.Resource._is_passthrough_type')
        ...
        self.get_userdata_patcher = mock.patch(
            'vdi.utils.remote.get_userdata_template')
