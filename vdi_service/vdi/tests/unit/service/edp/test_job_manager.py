...
from vdi.service.edp.workflow_creator import workflow_factory
...
class TestJobManager(base.SaharaWithDbTestCase):
    ...
    @mock.patch('vdi.utils.remote.get_remote')
    @mock.patch('vdi.service.edp.hdfs_helper.create_dir')
    ...
    @mock.patch('vdi.utils.remote.get_remote')
    @mock.patch('vdi.service.edp.hdfs_helper.put_file_to_hdfs')
    @mock.patch('vdi.service.edp.hdfs_helper._dir_missing')
    @mock.patch('vdi.utils.ssh_remote.InstanceInteropHelper')
    @mock.patch('vdi.conductor.API.job_binary_internal_get_raw_data')
    ...
    @mock.patch('vdi.conductor.API.job_binary_get')
    def test_build_workflow_for_job_pig(self, job_binary):
        ...
        input_data = _create_data_source('swift://ex.vdi/i')
        output_data = _create_data_source('swift://ex.vdi/o')
        ...
        self.assertIn("""
      <param>INPUT=swift://ex.vdi/i</param>
      <param>OUTPUT=swift://ex.vdi/o</param>""", res)
    ...
    def _build_workflow_common(self, job_type, streaming=False):
      ...
      <streaming>
        ...
        <property>
          ...
          <value>swift://ex.vdi/o</value>
        </property>""", res)

        self.assertIn("""
        <property>
          <name>mapred.input.dir</name>
          <value>swift://ex.vdi/i</value>
        </property>""", res)
