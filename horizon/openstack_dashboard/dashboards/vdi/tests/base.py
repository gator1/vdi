...
class UITestCase(unittest2.TestCase):
    ...
    def create_node_group_template(
        ...
        driver.get(cfg.common.base_url + "/vdi/nodegroup_templates/")
    ...
    def create_cluster_template(
        ...
        driver = self.driver
        driver.get(cfg.common.base_url + "/vdi/cluster_templates/")
    ...
    def create_cluster(self, name, cluster_template, plugin, keypair=None,
        ...
        driver = self.driver
        driver.get(cfg.common.base_url + "/vdi/")
    ...
    def create_data_source(self, name, url, close_window=True,
        ...
        driver = self.driver
        driver.get(cfg.common.base_url + "/vdi/data_sources/")
    ...
    def create_job_binary(self, name, parameters_of_storage, description=None,
        ...
        driver.get(cfg.common.base_url + "/vdi/job_binaries/")
    ...
    def create_job(self, name, job_type, main=None, libs=None,
        ...
        driver = self.driver
        driver.get(cfg.common.base_url + "/vdi/jobs/")
    ...
    def delete_all_job_executions(self):
        ...
        driver = self.driver
        driver.get(cfg.common.base_url + "/vdi/job_executions/")
