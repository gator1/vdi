...
from openstack_dashboard.dashboards.vdi.images.images import tabs as project_tabs


class CreateView(forms.ModalFormView):
    form_class = project_forms.CreateImageForm
    # template_name = 'project/images/images/create.html'
    template_name = 'vdi/images/images/create.html'
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'vdi/images/images/update.html'
    success_url = reverse_lazy("horizon:vdi:images:index")
    ...
    def get_object(self):
        try:
            ...
            url = reverse('horizon:vdi:images:index')
...
class DetailView(tabs.TabView):
    ...
    template_name = 'vdi/images/images/detail.html'
